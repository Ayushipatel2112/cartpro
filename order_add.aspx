<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_add.aspx.cs" Inherits="CartProWebApp.admin.order_add" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <main class="main-content">
                ...
                <div id="page-content">
                    <section id="order-add" class="page">
                        <div class="page-header">
                            <h1>Add New Order</h1>
                            <div class="header-actions">
                                <a href="orders.aspx" class="btn-secondary"><i class="fas fa-arrow-left"></i>Back to Orders</a>
                            </div>
                        </div>
                        ...
                        <div class="table-container">
                            ...
                            <div class="modal-actions">
                                ...
                                <asp:Button ID="btnSave" runat="server" Text="Save Order" CssClass="btn-primary" OnClick="btnSave_Click" />
                            </div>
                        </div>
                    </section>
                </div>
