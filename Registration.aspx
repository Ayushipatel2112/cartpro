<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="CartProWebApp.admin.Registration" %>
    ...
    <form id="form1" runat="server">
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header text-center h4 text-white" style="background-color: #3b5d50;">Register Admin</div>
                        <div class="card-body">
                            <div class="mb-3">
